...
filestoTransferGAP = [environ["CMSSW_BASE"] + "/src/SusyAnaTools/Tools/AliasTest",
...
#go make top plots!
submitFileGAP = """universe = vanilla
Executable = $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/condor/goAliasTest.sh
request_memory = 3100
Should_Transfer_Files = YES
WhenToTransferOutput = ON_EXIT
Transfer_Input_Files = $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/condor/goAliasTest.sh,$ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/condor/gap.tar.gz,$ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/condor/$ENV(CMSSW_VERSION).tar.gz 
Output = logs/AliasTestLogs_$(Process).stdout
Error = logs/AliasTestLogs_$(Process).stderr
Log = logs/AliasTestLogs_$(Process).log
...
submitFile = submitFileGAP
makeExeAndFriendsTarrball(filestoTransferGAP, "gap")
